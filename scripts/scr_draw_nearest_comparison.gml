...
for (i=0;i<line_count;i++) {
    ...
    draw_text_transformed(x_offset+padding,y_offset+(line_height*i)+padding, finaltext, 1, 1, 0);
}
...
draw_set_color(c_white);
draw_text(nearest_button_x1+width/2,nearest_button_y1+nearest_button_height/2-10,"Pick up");
